  ...
  <div className="h-full lg:px-6">
    <div
      ...
      <div className="mt-4 gap-2 flex flex-col xl:max-w-md w-full">
        <h3 style={{userSelect: 'none'}} className="text-xl font-semibold">特别鸣谢</h3>
    ...
    <div className="flex flex-col justify-center w-full py-5 px-4 lg:px-0  max-w-[90rem] mx-auto gap-3">
      <div className="flex justify-between" id='online-players'>
        <div style={{flex: 1, marginRight: '10px'}}>
          <Card>
            <Card className="bg-primary rounded-xl shadow-md ">
              <h3 style={{userSelect: 'none'}} className="text-center text-xl font-semibold mt-4 mb-4">大厅世界</h3>
            </Card>
        ...
        <div style={{flex: 1, marginRight: '10px'}}>
          <Card>
            <Card className="bg-success rounded-xl shadow-md ">
              <h3 style={{userSelect: 'none'}} className="text-center text-xl font-semibold mt-4 mb-4">生存世界</h3>
            </Card>
